# release.md — Release a new public marketplace version
...
4. GitHub Actions automatically builds and deploys (on tag push).
...
- [ ] `.github/workflows/verify.yml` passes (MUST)
...
- Monitor that verify.yml continues to pass on subsequent pushes.